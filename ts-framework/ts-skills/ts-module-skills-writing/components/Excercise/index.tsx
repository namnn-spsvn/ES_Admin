...
import { ArrowLeftOutlined, CaretRightOutlined, PauseOutlined, PictureOutlined, PlayCircleOutlined, PlusOutlined } from "@ant-design/icons";
import {
    useGetContentQuery,
...
import { useDeleteContentMutation } from "@/ts-framework/ts-skills/ts-module-skills-reading/apis";
...
export default function TopicDetailPage() {
        ...
        if (isNew) {
            ...
            setDetail({
                item: {
                    ...
                    media_image_url: "",
                    media_audio_url: "",
                    meta: { level: topicLevel, skill: "WRITING" },
                    is_published: false,
                },
                questions: [
                    {
    ...
    const handlePlayAudio = () => {
        ...
        // Nếu chưa có thì tạo audio mới
        const player = new Audio(url);
        setAudioPlayer(player);
        player.play();

        // Khi phát xong tự reset state
